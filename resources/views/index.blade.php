...
<body>
    ...
    <div class ="index_global">
        <main>
            ...
            <iframe width="560" height="315" src="https://www.youtube.com/embed/Bm2AoYIREoA?si=mMogIuPsb5-MHJrV" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
            </div>
        </main>
    </div>
    <div>
